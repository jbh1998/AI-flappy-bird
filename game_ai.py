...
class Bird(object):
    ...
    def get_inputs(self, pipe):
        """

        :param pipe:离鸟最近的那根管子
        :return:[鸟的相对y坐标，鸟右侧距管左侧的距离，鸟左侧距管子右侧的距离，鸟距离缝隙上部分的y距离，距离缝隙下部分的y距离]
        """
        inputs = []
...
class Game(object):
    ...
    def update(self):
        ...
        self.bird.update(self.pipeManager.pipes)
        self.score.update()
